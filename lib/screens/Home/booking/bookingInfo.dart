...
class BookingInfo extends StatefulWidget {
  final int bookingId;
  BookingInfo(this.bookingId);

  @override
  _BookingInfoState createState() => _BookingInfoState(this.bookingId);
}
...
class _BookingInfoState extends State<BookingInfo> {
  ...
  _BookingInfoState(this.bookingId) {
  ...
  Future getBookingDetail(int id) async {
    ...
    bookingitem.BookingItem bitem = new bookingitem.BookingItem(
        ...
        res['service']?['price'],
        res['washer']?['name'],
        res['lat'] != null ? res['lat'] : 0.00,
        res['lng'] != null ? res['lng'] : 0.00);
    EasyLoading.dismiss();
    return bitem;
  }
